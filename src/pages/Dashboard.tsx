        ...
        {!isConnected ? (
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
            ...
            <p className="text-slate-400 mb-6 max-w-md">
              Подключите диагностический адаптер к отопителю через Bluetooth или USB для начала работы
            </p>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-green-500/10 rounded-lg border border-green-500/30">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 bg-green-500/20 rounded-lg flex items-center justify-center">
                          <Icon name="Bluetooth" size={24} className="text-green-400" />
                        </div>
                        <div>
                          <p className="font-medium">Bluetooth подключен</p>
